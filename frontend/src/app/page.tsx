...
const t = {
  es: {
    ...
    precision: 'Precision',
    medicine: 'Medicine',
    description: 'Soporte clínico avanzado para odontología. Seguridad multi-tenant y orquestación Gemini 3.1 Pro.',
    authNow: 'Autenticar Ahora',
    goDashboard: 'Ir al Dashboard',
    features: [
      { label: 'Seguridad Total', color: 'bg-blue-50 text-blue-600' },
      { label: 'Motor Gemini 3.1', color: 'bg-green-50 text-green-600' },
      { label: 'Aislamiento Tenant', color: 'bg-rose-50 text-rose-600' },
      { label: 'Analytics RAG', color: 'bg-yellow-50 text-yellow-700' },
    ],
    terminal: 'Terminal de Control',
    agent: 'Consola de Agente IA',
  ...
  en: {
    ...
    precision: 'Precision',
    medicine: 'Medicine',
    description: 'Advanced clinical support for dentistry. Multi-tenant security and Gemini 3.1 Pro orchestration.',
    authNow: 'Authenticate Now',
    goDashboard: 'Go to Dashboard',
    features: [
      { label: 'Total Security', color: 'bg-blue-50 text-blue-600' },
      { label: 'Gemini 3.1 Engine', color: 'bg-green-50 text-green-600' },
      { label: 'Tenant Isolation', color: 'bg-rose-50 text-rose-600' },
      { label: 'RAG Analytics', color: 'bg-yellow-50 text-yellow-700' },
    ],
