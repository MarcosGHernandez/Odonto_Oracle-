  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white dark:bg-black p-6">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-5 dark:opacity-10">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 border-2 border-slate-900 dark:border-white rounded-full translate-x-[-50%] translate-y-[-50%]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="text-[10px] font-bold text-slate-400 dark:text-zinc-500 uppercase tracking-[0.2em] mt-1">Portal de Acceso Clínico</p>
        </div>
        ...
        <SignIn 
          appearance={{
            elements: {
              ...
              formResendCodeLink: "text-slate-900 dark:text-white font-bold",
            }
          }}
        />
      </div>
